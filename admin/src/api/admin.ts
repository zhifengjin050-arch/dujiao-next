...
export const adminAPI = {
  ...
  listProductSkus: (params?: Record<string, unknown>) => api.get('/admin/product-skus', { params }),
  ...
  exportOrders: (params?: Record<string, unknown>) => api.get('/admin/orders/export', { params, blob: true }),
